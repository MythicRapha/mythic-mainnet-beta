      ...
      <section className="py-[100px] sm:py-[120px] border-t border-white/[0.06]">
        <div className="max-w-[1280px] mx-auto px-5 sm:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            {/* mythic.fun — Launchpad */}
            <a href="https://mythic.fun" target="_blank" rel="noopener noreferrer" className="group bg-[#08080C] border border-white/[0.06] p-8 hover:border-[#00E5FF]/30 transition-colors">
              ...
              <h4 className="font-display text-white font-semibold text-[1rem] mb-2 group-hover:text-[#00E5FF] transition-colors">mythic.fun</h4>
